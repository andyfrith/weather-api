...
export const MainWeatherSchema = z.object({
  ...
  sea_level: z.number().optional().describe("Atmospheric pressure at sea level in hPa"),
  grnd_level: z.number().optional().describe("Atmospheric pressure at ground level in hPa"),
});
...
export const RainSchema = z.object({
  ...
  "3h": z.number().optional().describe("Rain volume for the last 3 hours in mm"),
});
...
export const SnowSchema = z.object({
  ...
  "3h": z.number().optional().describe("Snow volume for the last 3 hours in mm"),
});
...
export const GeocodingResultSchema = z.object({
  ...
  local_names: z.record(z.string(), z.string()).optional().describe("Localized names in different languages"),
